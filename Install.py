...
os.system("python3 -m pip install numpy==1.26.4 openwakeword xmltodict speechRecognition nltk gTTS weather2 wikipedia google transformers torch simpleaudio pygame pydub flask pyalsaaudio pyaudio piper-tts faster_whisper")
